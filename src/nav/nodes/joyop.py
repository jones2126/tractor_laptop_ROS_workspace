...
# https://github.com/gkouros/ackermann-drive-teleop/blob/master/scripts/joyop.py
'''
...
class AckermannDriveJoyop:
    ...
    def __init__(self, args):
        '''
        rospy.loginfo(len(args))
        rospy.loginfo(args)
        rospy.loginfo(float(args[0]))
        rospy.loginfo(float(args[1]))
        ...
        rospy.loginfo(self.max_speed)
        rospy.loginfo(self.max_steering_angle)
