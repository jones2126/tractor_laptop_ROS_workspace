...
void getControlReadings(){
    ...
    /*
    // I want to change this from being a set value to a mapped value
    // What is straight?
    // What is full left and full right
Based on values below, left is 0 - 451; Right is 451-4096
So the map function would be
if steering_val < (451-10)
    RadioControlData.steering_val = map(steering_val, 0, (451-10), -45, 0);
elseif steering_val > (451+10)
    RadioControlData.steering_val = map(steering_val, (451+10), 4095 0, 45);
else
    RadioControlData.steering_val = 0
example:   transmissionServoValue = map(RadioControlData.throttle_val, 0, 4095, 50, 110);    // - 60=reverse; 73=neutral; 92=first
int SteeeringPts[arraySize] = {0, 130, 298, 451, 1233, 2351, 3468, 4094, 4096, 4097}; 
float SteeeringValues[] = {-45, -30, -15, 0, 15, 30, 45, 45, 45, 99};    
*/
...
void displayOLED(){
  ...
  display.setCursor(0,47);  display.print("Steering:"); display.setCursor(58,47); display.print(steering_val);
