...
"""
Subscribes to a ROS topic in line 28 and displays the result in a tkinter window
...
class Display_Sensor_1(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.sub = rospy.Subscriber("bno085_imuacc", Float32, self.callback_sensor_1)
        self.sensor_1_data = tk.IntVar()

        # configure the root window
        self.title('IMU Accuracy')
        self.resizable(0, 0)
        # width x height = 1920 x 1080 (in pixels) of the Ubuntu laptop
        self.geometry('225x70+1350+100')
        self['bg'] = 'black'
    ...
    def callback_sensor_1(self, data):
        ...
        # self.sensor_1_data = data.data  # an earlier version, keeping here fyi
