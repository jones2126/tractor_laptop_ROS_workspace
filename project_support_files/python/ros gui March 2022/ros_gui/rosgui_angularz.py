...
class Display_Sensor_1(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title('cmd_vel Angular Z')
        self.resizable(0, 0)
        # width x height = 1920 x 1080 (in pixels) of the Ubuntu laptop
        self.geometry('225x70+1600+300')
        self['bg'] = 'black'
    ...
    def update(self):
        ...
        self.label.after(200, self.update)     # schedule another timer, schedule an update 5 times/second - 200 ms
