...
import rospy
from std_msgs.msg import Float32    # from std_msgs.msg import Int16      # from geometry_msgs.msg import Twist     

"""
Subscribes to a ROS topic and displays the result in a tkinter window
...
This script can be started from the folder it resides in with $ python3 rosgui_{module name}.py
...
class Display_Sensor_1(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.sub = rospy.Subscriber("/left_speed", Float32, self.callback_sensor_1)
        self.sensor_1_data = tk.IntVar()

        # configure the root window
        self.title('Wheel Speed (left)')
        self.resizable(0, 0)
        # width x height = 1920 x 1080 (in pixels) of the Ubuntu laptop
        self.geometry('225x70+1600+500')
        self['bg'] = 'black'
        ...
        self.label.after(250, self.update)     # schedule an update every 1 second
    ...
    def update(self):
        ...
        self.label.after(250, self.update)     # schedule another timer
