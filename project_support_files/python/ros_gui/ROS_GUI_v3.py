...
# launch Docker container and start ROSCORE
global windowid1
global cmd_RPi_login
subprocess.call(["xdotool", "windowfocus", windowid1])
time.sleep(.1)
subprocess.call(["xdotool", "key", "alt+7"])
time.sleep(.1)
subprocess.check_output(["xdotool", "type", "./start.sh" + "\n"])
time.sleep(3)
subprocess.check_output(["xdotool", "type", "roscore" + "\n"])
time.sleep(3)
...
time.sleep(.1)
subprocess.check_output(["xdotool", "type", "roslaunch tractor_teleop drive.launch" + "\n"])
time.sleep(10) # delay for the login process to the RPi
